...
export interface ConfidentialUSDCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
  ...
  encodeFunctionData(
    functionFragment: "underlyingUSDC",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ConfidentialUSDC extends BaseContract {
  connect(runner?: ContractRunner | null): ConfidentialUSDC;
  waitForDeployment(): Promise<this>;

  interface: ConfidentialUSDCInterface;
  ...
  underlyingUSDC: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "underlyingUSDC"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
