...
export interface ConfidentialUSDTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
  ...
  encodeFunctionData(
    functionFragment: "underlyingUSDT",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ConfidentialUSDT extends BaseContract {
  connect(runner?: ContractRunner | null): ConfidentialUSDT;
  waitForDeployment(): Promise<this>;

  interface: ConfidentialUSDTInterface;
  ...
  underlyingUSDT: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "underlyingUSDT"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
